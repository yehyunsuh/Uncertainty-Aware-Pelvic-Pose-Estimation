python3 -m src.train_deepfluoro_real.main \
  ...
  --wandb_name 18-2800_synthetic_imagenet
...
python3 -m src.train_deepfluoro_real.main \
  ...
  --init_mode synthetic \
  --specimen_id 18-2800 \
  --synthetic_weight_path model_weight/train_deepfluoro_real/18-2800_synthetic_imagenet_dist.pth \
  --wandb \
...
python3  -m src.train_deepfluoro_real.main \
  ...
  --wandb \
  --wandb_project "DeepFluoro Real Held-Out" \
  --wandb_name 18-2800_real_imagenet
