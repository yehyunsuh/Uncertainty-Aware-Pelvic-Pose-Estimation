python3 -m src.train_deepfluoro_real.main \
  ...
  --wandb_name 17-1905_synthetic_imagenet
...
python3 -m src.train_deepfluoro_real.main \
  ...
  --init_mode synthetic \
  --specimen_id 17-1905 \
  --synthetic_weight_path model_weight/train_deepfluoro_real/17-1905_synthetic_imagenet_dist.pth \
  --wandb \
...
python3  -m src.train_deepfluoro_real.main \
  ...
  --wandb \
  --wandb_project "DeepFluoro Real Held-Out" \
  --wandb_name 17-1905_real_imagenet
